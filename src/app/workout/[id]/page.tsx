      ...
      <div className="card live-card d1">
        ...
        <div className="flex gap-2 mt-2 flex-wrap">
          <form action={goToEnd}>
            ...
            <button className="sticker-btn primary" type="submit">finish ▸</button>
          </form>
          <form action={abandonWorkout}>
            <input type="hidden" name="workoutId" value={workout.id} />
            <button className="sticker-btn" type="submit">abandon</button>
          </form>
        </div>
      </div>

      <WorkoutClient workoutId={workout.id} blocks={blocks} sets={sets} editable />
